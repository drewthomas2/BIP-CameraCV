...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst4 = 176.4f / fConst0;
		fConst5 = 1.33333f / fConst0;
		fConst6 = 1.5f / fConst0;
		fConst7 = 1.0f / fConst0;
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(9e+01f);
		fHslider1 = FAUSTFLOAT(277.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("faust3");
		ui_interface->addHorizontalSlider("filt gain", &fHslider3, FAUSTFLOAT(0.4f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("gain1", &fHslider2, FAUSTFLOAT(0.2f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("hue", &fHslider0, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.8e+02f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("pitch", &fHslider1, FAUSTFLOAT(277.0f), FAUSTFLOAT(5e+01f), FAUSTFLOAT(6.6e+02f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp0 = std::tan(fConst3 * (2e+01f * fRec0[0] + 5e+01f));
			float fTemp1 = 1.0f / fTemp0;
			fRec1[0] = fConst4 + fConst2 * fRec1[1];
			float fTemp2 = 1.0f / fRec1[0];
			float fTemp3 = (fTemp2 + fTemp1) / fTemp0 + 1.0f;
			iRec4[0] = 1103515245 * iRec4[1] + 12345;
			fRec3[0] = 0.5221894f * fRec3[3] + 4.656613e-10f * float(iRec4[0]) + 2.494956f * fRec3[1] - 2.0172658f * fRec3[2];
			int iTemp4 = 1 - iVec0[1];
			fRec7[0] = fSlow1 + fConst2 * fRec7[1];
			float fTemp5 = ((iTemp4) ? 0.0f : fRec6[1] + fConst5 * fRec7[0]);
			fRec6[0] = fTemp5 - std::floor(fTemp5);
			float fTemp6 = ((iTemp4) ? 0.0f : fRec8[1] + fConst6 * fRec7[0]);
			fRec8[0] = fTemp6 - std::floor(fTemp6);
			float fTemp7 = ((iTemp4) ? 0.0f : fRec9[1] + fConst7 * fRec7[0]);
			fRec9[0] = fTemp7 - std::floor(fTemp7);
			float fTemp8 = ((iTemp4) ? 0.0f : fRec10[1] + fConst7 * (std::fmod(fRec0[0], 2.0f) + 0.25f));
			fRec10[0] = fTemp8 - std::floor(fTemp8);
			fRec11[0] = fSlow2 + fConst2 * fRec11[1];
			fRec2[0] = 0.0506127f * fRec3[2] + fRec11[0] * (1.0f - std::fabs(2.0f * fRec10[0] + -1.0f)) * (ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec9[0]), 65535))] + ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec8[0]), 65535))] + ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec6[0]), 65535))]) + 0.049922034f * fRec3[0] - (0.095993534f * fRec3[1] + 0.004408786f * fRec3[3] + (fRec2[2] * ((fTemp1 - fTemp2) / fTemp0 + 1.0f) + 2.0f * fRec2[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp0))) / fTemp3);
			fRec12[0] = fSlow3 + fConst2 * fRec12[1];
			output0[i0] = FAUSTFLOAT(fRec12[0] * (fRec2[2] + fRec2[0] + 2.0f * fRec2[1]) / fTemp3);
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			iRec4[1] = iRec4[0];
	...
	#define FAUST_FILE_NAME "faust3.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("filt gain", fHslider3, 0.4f, 0.0f, 1.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("gain1", fHslider2, 0.2f, 0.0f, 1.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("hue", fHslider0, 9e+01f, 0.0f, 1.8e+02f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("pitch", fHslider1, 277.0f, 5e+01f, 6.6e+02f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, filt_gain, "filt gain", fHslider3, 0.4f, 0.0f, 1.0f, 0.1f) \
		p(HORIZONTALSLIDER, gain1, "gain1", fHslider2, 0.2f, 0.0f, 1.0f, 0.1f) \
		p(HORIZONTALSLIDER, hue, "hue", fHslider0, 9e+01f, 0.0f, 1.8e+02f, 1.0f) \
		p(HORIZONTALSLIDER, pitch, "pitch", fHslider1, 277.0f, 5e+01f, 6.6e+02f, 1.0f) \
...
faust3::faust3() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void faust3::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void faust3::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float faust3::getParamValue(const std::string& path)
{
